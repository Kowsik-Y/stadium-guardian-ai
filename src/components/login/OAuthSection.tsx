...
export default function OAuthSection({ handleGoogleSignIn, loading }: OAuthSectionProps) {
  return (
    <>
      ...
      >
        <svg className="h-4 w-4 mr-1" aria-hidden="true" viewBox="0 0 24 24" fill="currentColor">
          <path
